...
public class GroupLevelException extends RuntimeException {
     ...
     */
    public GroupLevelException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public GroupLevelException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public GroupLevelException(Throwable cause) {
        super(cause);
    }
